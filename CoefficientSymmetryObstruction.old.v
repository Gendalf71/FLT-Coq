...
(* ============================================================= *)
(*  Coefficient-symmetry compatibility reading, version 15.       *)
...
(*  The compatibility obstruction is l^n = q^n iff n = 2^(n-1),  *)
(*  and n = 2^(n-1) implies n in {1,2}.                          *)
(* ============================================================= *)
...
(* ---------- Coefficient-symmetry compatibility, version 15 ---------- *)
Local Open Scope R_scope.
